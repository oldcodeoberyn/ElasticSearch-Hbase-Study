...
//		conf.addResource( "hbase-client.xml" );
		conf.set("hbase.zookeeper.quorum","euca-10-254-68-9,euca-10-254-81-90,euca-10-254-82-179,euca-10-254-65-90,euca-10-254-71-25,euca-10-254-76-187,euca-10-254-73-33");
		try {
...
//		Filter
	...
	// 读取一条记录
		...
		public  void put(String tableName, String row, String columnFamily,
			...
			p1.addColumn(columnFamily.getBytes(),column.getBytes(),data.getBytes("UTF-8"));
			table.put(p1);
